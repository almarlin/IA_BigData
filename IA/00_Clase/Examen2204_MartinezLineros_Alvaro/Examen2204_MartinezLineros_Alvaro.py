...
# Creamos la blockchain y el primer bloque
bc = Blockchain()
bc.crear_bloque_genesis()
...
for i in range(0,15):
    ...
    bc.agregar_bloque(emisor="local",receptor="nube",mensaje={
...
df.to_json("simulacion.json",indent=4)
bc.to_txt()


# Modificamos la cadena para comprobar como se rompe

print(f"¿La cadena es válida? {bc.es_valida()}")

print(f"\nVamos a modificar el bloque 2 de la cadena...")
bc.cadena[2].mensaje = "Modificado"
print(f"¿Es válida la cadena? {bc.es_valida()}")
